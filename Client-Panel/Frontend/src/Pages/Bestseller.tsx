    ...
    <div className="flex flex-col gap-10 px-4 inset-0 bg-[#F5F5DC]">
      ...
      {products.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-purple-700 uppercase tracking-widest animate-pulse">
            Products are arriving!
          </h2>
          <p className="text-sm sm:text-base text-gray-600 max-w-md">
            Our latest collection is currently being stocked. Check back in a few moments to see our new arrivals.
          </p>
        </div>
      ) : (
        <FilterSection
